...
class NMTVectorizer(object):
    ...
    def __init__(self, source_vocab, target_vocab, max_source_length, max_target_length):
        ...
        self.max_source_length = 1313
        self.max_target_length = 78
    ...
    def vectorize(self, source_text, target_text, use_dataset_max_lengths=True):
        ...
        source_vector = self._vectorize(source_indices,
                                        ...
                                        mask_index=target_vector_length)

        target_x_indices, target_y_indices = self._get_target_indices(target_text)
        target_x_vector = self._vectorize(target_x_indices,
                                          vector_length=self.max_target_length + 1,
...
class NMTEncoder(nn.Module):
    def __init__(self, num_embeddings, embedding_size, rnn_hidden_size):
        ...
        self.birnn = nn.LSTM(embedding_size, rnn_hidden_size, bidirectional=True, batch_first=True)
    ...
    def forward(self, x_source, x_lengths):
        ...
        x_birnn_out, (x_birnn_h, _) = self.birnn(x_packed)
...
args = Namespace(dataset_csv="data/gazeta_train.csv",
...
results = get_all_sentences(vectorizer, batch_dict, 2)
print()
print('> ', results['source'], end='\n\n')
print('#' * 80, end='\n\n')
print('= ', results['truth'], end='\n\n')
print('#' * 80, end='\n\n')
print('~ ', results['sampled'], end='\n\n')


"""
=   сборная россии осталась без медалей в женской эстафете на проходящем в <UNK> 
    чемпионате мира золото завоевала сборная норвегии ведомая <UNK> бергер серебро досталось команде 
    украины бронза – <UNK> россиянки вновь остановились в шаге от пьедестала

################################################################################

~   сборная россии завоевала в наград в чемпионате эстафете в чемпионате в 
    австрийском в мира по в серебро россии заняла в <UNK> выиграла в <UNK>
"""
